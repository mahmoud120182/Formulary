...
const medicationData = [
    ...
    },
    {
        ...
        category: "First-Generation Antiepileptic Drug (AED)",
        available: true,
        package: "20 TAB",
        halfLife: "Initial: 25-65 hours, With repeated doses: 12-17 hours (due to auto-induction)",
        sideEffects: ["Dizziness", "Drowsiness (somnolence)", "Nausea and Vomiting", "Diplopia (double vision)", "Blurred vision", "Ataxia (unsteady gait)", "Headache"],
        interactions: ["DOACs (apixaban, rivaroxaban)", "statins", "warfarin", "many antidepressants", "birth control pills (can cause failure)", "(auto-induction), meaning the dose often needs to be increased after the first few weeks of treatment.", "Drugs that increase its levels: macrolide antibiotics (erythromycin), azole antifungals (fluconazole)"],
        monitor: [ "Reduction in trigeminal neuralgia pain episodes" , "Mood stability in bipolar disorder", "Visual disturbances (blurred vision, double vision)", "Signs of hyponatremia: headache, confusion, lethargy, nausea" , "Fever, sore throat, mouth ulcers (signs of agranulocytosis)", "Skin rash (potential sign of serious reaction like SJS/TEN)", "Easy bruising or bleeding (sign of aplastic anemia)", "Jaundice (yellow skin/eyes), dark urine (sign of hepatotoxicity)"],
        importantInvestigations: ["CBC (for blood cell counts)", "Liver Function Tests (LFTs)", "Sodium Level (for hyponatremia)", "Carbamazepine Trough Level (therapeutic range 4-12 mcg/mL)", "Pregnancy Test (teratogenic)"]
    },
    {
