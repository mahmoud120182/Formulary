...
const medicationData = [
  {
    ...
    importantInvestigations: [
      "Liver Function Tests (LFTs) - Baseline and periodic",
    ],
  },
  {
  ...
  },
  {
    ...
    monitor: [
      "Neuropsychiatric effects (confusion, hallucinations)",
  ...
  },
  {
    ...
    interactions: [
      "Other CNS depressants",
      "Levodopa",
      "Drugs that prolong QTc (e.g., Erythromycin)",
    ],
    monitor: [
      "Extrapyramidal symptoms (EPS)",
      "akathisia",
      "sedation",
      "prolactin-related effects (galactorrhea, gynecomastia)",
    ],
  ...
  },
  {
    ...
    sideEffects: [
      ...
      "insomnia",
      "anxiety",
      "extrapyramidal symptoms (at low doses)",
    ],
    interactions: [
      "Other CNS depressants",
      "Levodopa",
  ...
  },
  {
    ...
    monitor: [
      ...
      "cardiac conduction (monitor for QT prolongation clinically)",
    ],
    importantInvestigations: [
  ...
  },
  {
    ...
    monitor: [
      "Sleep patterns",
      "alertness",
      "psychiatric symptoms (anxiety, agitation, mania)",
      "skin reactions",
    ],
  ...
  },
  {
    ...
    monitor: [
      ...
      "EPS",
      "weight gain",
      "oral hypoesthesia (numbness after sublingual use)",
      "dysphagia",
    ],
    importantInvestigations: [
      "Fasting Blood Glucose",
  ...
  },
  {
    ...
    importantInvestigations: [
      "Heart rate and blood pressure (baseline and periodic)",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "None routine; caution in glaucoma, prostate issues",
    ],
  },
  {
  ...
  },
  {
    ...
    interactions: [
      "CYP3A4/2D6 inducers/inhibitors (e.g., Carbamazepine/Paroxetine)",
    ],
    monitor: [
      "EPS",
      "akathisia",
  ...
  },
  {
    ...
    interactions: [
      ...
      "CYP2D6 substrates (e.g., Tamoxifen)",
    ],
    monitor: [
      "Seizure threshold (seizure activity)",
      "insomnia",
      "agitation",
      "mood changes",
      "suicidal ideation",
  ...
  },
  {
    ...
    importantInvestigations: [
      "None routine; monitor for symptoms of dyskinesia",
    ],
  },
  {
    ...
    interactions: [
      "Strong CYP3A4 inhibitors/inducers (e.g., Ketoconazole/Carbamazepine)",
    ],
    monitor: [
      "EPS",
      "akathisia",
      ...
      "mood changes",
      "weight gain",
      "QT interval (clinical monitoring for arrhythmia symptoms)",
    ],
    importantInvestigations: [
      "Fasting Blood Glucose",
      "Lipids (baseline and periodic)",
  ...
  },
  {
    ...
    interactions: [
      "MAOIs",
      "drugs that prolong QTc (e.g., Pimozide)",
      "CYP2C19 inhibitors",
    ],
    monitor: [
    ...
    importantInvestigations: [
      "ECG (QTc interval, esp. with high dose or cardiac risk)",
    ],
  },
  {
  ...
  },
  {
    ...
    interactions: [
      ...
      "CNS depressants",
      "CYP1A2/2D6 inhibitors/inducers",
    ],
    monitor: [
      "Fever",
      "sore throat",
      "lethargy (signs of agranulocytosis)",
      "sedation",
      "sialorrhea",
      "seizures",
      "constipation",
    ...
    importantInvestigations: [
      "Absolute Neutrophil Count (ANC) - Weekly then monthly",
      "Weight",
      "ECG",
      "LFTs",
    ],
  ...
  },
  {
    ...
    interactions: [
      "Anticholinergics",
      "Cholinergic agents",
      "CYP2D6/3A4 inhibitors (e.g., Ketoconazole)",
    ],
    monitor: [
      "GI tolerability (nausea, vomiting)",
      "bradycardia",
      "syncope",
      "sleep disturbances",
      "muscle cramps",
    ...
    importantInvestigations: [
      "None routine; monitor for weight loss, bradycardia",
    ],
  },
  {
  ...
  },
  {
    ...
    monitor: [
      "Mood changes",
      "suicidal ideation",
      "QT prolongation (palpitations, dizziness)",
      "serotonin syndrome",
    ],
  ...
  },
  {
    ...
    package: "5 amp",
    halfLife:
      "Terminal half-life is 40 to 80 minutes (Initial distribution half-life: 4 to 11 minutes)",
    sideEffects: [
      "Nausea",
      "vomiting",
      "dizziness",
      ...
      "seizures (especially in physically dependent patients or mixed overdose)",
    ],
    interactions: [
      "Benzodiazepines (reverses effect)",
      "Cyclic Antidepressants (Increased risk of seizures and arrhythmias, use is generally contraindicated in suspected overdose)",
      "Other drugs that can cause seizures or arrhythmias (e.g., chloral hydrate, carbamazepine)",
    ],
    monitor: [
      "Resedation and recurrence of respiratory depression (due to Flumazenil's shorter half-life compared to many benzodiazepines)",
      "Level of consciousness/sedation (e.g., Glasgow Coma Scale)",
      "Vital signs (especially respiratory rate, blood pressure, and heart rate)",
      "Signs of precipitated benzodiazepine withdrawal/seizures",
    ],
    importantInvestigations: [
      "Close monitoring until risk of resedation has passed (typically 1-2 hours, or longer for large benzodiazepine doses)",
      "ECG (to rule out QRS prolongation from co-ingested tricyclic antidepressants before use in overdose)",
    ],
  },
  {
    ...
    interactions: [
      "MAOIs",
      "Serotonergic drugs",
      "CYP2D6 substrates (e.g., Tamoxifen, Codeine)",
      "Triptans",
    ],
    monitor: [
      "Mood changes",
  ...
  },
  {
    ...
    interactions: [
      "MAOIs",
      "Serotonergic drugs",
      "Strong CYP1A2/2C19/3A4 inhibitor (many interactions: Theophylline, Clozapine, Warfarin)",
    ],
    monitor: [
      "Sedation",
      "GI upset",
  ...
  },
  {
    ...
    interactions: [
      "CNS depressants",
      "Levodopa",
      "Drugs that prolong QTc (e.g., Amiodarone)",
  ...
  },
  {
    ...
    interactions: [
      "NSAIDs",
      "ACEi/ARBs",
      "Diuretics (can increase levels and toxicity)",
      "Theophylline",
      "Caffeine (can decrease levels)",
    ],
    monitor: [
      "Thirst",
      "polyuria",
  ...
  },
  {
    ...
    interactions: [
      "Strong CYP3A4 inhibitors/inducers (e.g., Ketoconazole/Rifampin)",
      "Grapefruit juice",
    ],
    monitor: [
      "Sedation",
  ...
  },
  {
    ...
    interactions: [
      "Urinary alkalinizers (e.g., Carbonic Anhydrase Inhibitors)",
      "NMDA antagonists (e.g., Amantadine, Dextromethorphan)",
    ],
    monitor: [
      "Cognitive function",
      "behavioral changes",
    ...
    importantInvestigations: [
      "None routine; caution in severe renal impairment",
    ],
  },
  {
  ...
  },
  {
    ...
    interactions: [
      "CNS depressants (alcohol, opioids, other sedatives)",
      "CYP3A4 inhibitors (e.g., ketoconazole)",
    ],
    monitor: [
      "Sedation level",
    ...
    importantInvestigations: [
      "Monitor for respiratory depression, especially with IV use.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor weight and cholesterol. Sedation is often dose-limiting.",
    ],
  },
  {
  ...
  },
  {
    ...
    monitor: [
      "Sleep patterns",
      "blood pressure",
      "psychiatric symptoms (anxiety, mania)",
      "rash",
    ],
    importantInvestigations: [
      "Monitor for signs of misuse or abuse. Reduces efficacy of birth control.",
    ],
  },
  {
    ...
    interactions: [
      "Opioid analgesics (will block effect)",
      "hepatotoxic drugs",
    ],
    monitor: [
      "Psychosocial functioning",
      "craving reduction",
      "opioid withdrawal if used in detox",
    ],
    importantInvestigations: [
      "Patient must be opioid-free before initiation to avoid precipitated withdrawal.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor weight, blood glucose, and lipids regularly.",
    ],
  },
  {
    name: "OLAPEX 5mg Tab.",
  ...
  },
  {
    ...
    interactions: [
      "CYP3A4 substrates (e.g., hormonal contraceptives - reduced efficacy)",
      "other CNS depressants",
    ],
    monitor: [
      "Dizziness",
      "ataxia",
      "hyponatremia symptoms (headache, confusion)",
      "rash",
    ],
    importantInvestigations: [
      "Monitor serum sodium levels, especially early in therapy.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor for EPS and akathisia. Administer by deep IM gluteal injection.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor for EPS and akathisia. 3-month formulation. Administer by deep IM gluteal injection.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Do not crush or chew tablet (ER formulation). Monitor for EPS.",
    ],
  },
  {
    name: "INVEGA 6mg Tab.",
  ...
  },
  {
    ...
    interactions: [
      "MAOIs (contraindicated)",
      "serotonergic drugs",
      "NSAIDs/aspirin (increased bleed risk)",
      "CYP2D6 substrates",
    ],
    monitor: [
      "Sedation",
    ...
    importantInvestigations: [
      "Strong CYP2D6 inhibitor. Has more anticholinergic effects than other SSRIs.",
    ],
  },
  {
  ...
  },
  {
    ...
    interactions: [
      "CYP450 inducers (affects many drugs)",
      "warfarin",
    ...
    importantInvestigations: [
      "Therapeutic drug monitoring required. Highly protein-bound.",
    ],
  },
  {
  ...
  },
  {
    ...
    active: "Pimozide",
    category:
      "Typical Antipsychotic (First Generation, Diphenylbutylpiperidine)",
    available: true,
    package: "20 TAB",
    ...
    interactions: [
      ...
      "CYP1A2 inhibitors",
      "other QTc-prolonging drugs (e.g., amiodarone, citalopram)",
      "CNS depressants",
    ],
    monitor: [
      "QTc interval",
      "EPS",
      "sedation",
      "signs of infection (agranulocytosis)",
      "cardiac symptoms (palpitations, syncope)",
    ],
    importantInvestigations: [
      "ECG (QTc interval) – baseline and periodically",
      "CBC (rare agranulocytosis)",
    ],
  },
  {
    ...
    importantInvestigations: [
      "Monitor for CNS side effects. Use with caution in those with bleeding risk.",
    ],
  },
  {
  ...
  {
    name: "NOOTROPIL 1GM/5ML IV/IM AMP.",
    active: "Piracetam",
    category: "Nootropic",
    available: false,
    package: "6 AMP",
  ...
  {
    name: "MEMORAL 1GM/5ML IV/IM AMP.",
    active: "Piracetam",
    category: "Nootropic",
    available: true,
    package: "6 AMP",
  ...
  {
    name: "CEREBROCETAM 1GM/5ML IV/IM AMP.",
    active: "Piracetam",
    category: "Nootropic",
    available: false,
    package: "6 AMP",
  ...
  },
  {
    ...
    interactions: [
      "Antipsychotics (may diminish effect)",
      "other CNS depressants",
    ...
    importantInvestigations: [
      "Warn about potential for impulsive behaviors (gambling, shopping, etc.). Titrate slowly.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor for EPS and akathisia. Dose-dependent EPS risk.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Can be more activating than other SSRIs. Usually taken in the morning.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor for EPS. Higher risk of hyperprolactinemia compared to some other antipsychotics.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Monitor for cognitive slowing and word-finding difficulty. Encourage hydration.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Risk of priapism (rare but serious). Often used off-label for insomnia at lower doses.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Higher potency typical antipsychotic. Monitor closely for EPS and akathisia.",
    ],
  },
  {
  ...
  },
  {
    ...
    interactions: [
      "Other CNS depressants",
      "lamotrigine (increases risk of SJS)",
    ...
    monitor: [
      ...
      "weight gain",
      "hair loss",
      "encephalopathy signs (lethargy, confusion)",
    ],
    importantInvestigations: [
      "Monitor CBC, LFTs, and valproic acid levels. High risk of neural tube defects in pregnancy.",
    ],
  },
  {
    ...
    importantInvestigations: [
      "Monitor blood pressure, especially at higher doses (>150mg/day). Can be difficult to discontinue.",
    ],
  },
  {
    ...
    importantInvestigations: [
      "Monitor blood pressure. Withdrawal syndrome common if stopped abruptly.",
    ],
  },
  {
    ...
    importantInvestigations: [
      "Monitor blood pressure, especially at higher doses. Withdrawal syndrome common.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "May have a lower incidence of sexual dysfunction compared to some SSRIs/SNRIs.",
    ],
  },
  {
  ...
  },
  {
    ...
    importantInvestigations: [
      "Risk of tolerance and dependence. Avoid alcohol. Can cause complex sleep behaviors.",
    ],
  },
  {
    ...
    active: "Gabapentin",
    category:
      "Anticonvulsant / Neuropathic pain agent (GABA analog, though not acting directly on GABA receptors)",
    available: true,
    package: "30 CAP",
    halfLife: "5–7 hours",
    sideEffects: [
    ...
    monitor: [
      "CNS depression (drowsiness, dizziness, impaired coordination) – especially when initiating or increasing dose",
      "Mood changes (depression, anxiety, suicidal ideation) – per FDA black box warning for antiepileptics",
      "Signs of hypersensitivity (rash, fever, lymphadenopathy)",
      "Peripheral edema – monitor for swelling in extremities",
      "Respiratory depression – especially when combined with CNS depressants (opioids, benzodiazepines)",
      "Weight gain and appetite changes",
      "Withdrawal symptoms (insomnia, nausea, headache, anxiety) – avoid abrupt discontinuation.",
    ],
    importantInvestigations: [
      "Renal function tests (serum creatinine, eGFR) – Gabapentin is renally excreted; dose adjustment needed in renal impairment",
      "Liver function tests (LFTs) – Rare hepatotoxicity; baseline and periodic monitoring in long-term use",
      "Electrolytes – Occasionally monitored due to edema or fluid retention.",
    ],
  },
  {
  ...
  },
  {
    ...
    package: "20 TAB",
    halfLife:
      "Initial: 25-65 hours, With repeated doses: 12-17 hours (due to auto-induction)",
    sideEffects: [
      "Dizziness",
    ...
    interactions: [
      ...
      "birth control pills (can cause failure)",
      "(auto-induction), meaning the dose often needs to be increased after the first few weeks of treatment.",
      "Drugs that increase its levels: macrolide antibiotics (erythromycin), azole antifungals (fluconazole)",
    ],
    monitor: [
      "Reduction in trigeminal neuralgia pain episodes",
      "Mood stability in bipolar disorder",
      "Visual disturbances (blurred vision, double vision)",
      "Signs of hyponatremia: headache, confusion, lethargy, nausea",
      "Fever, sore throat, mouth ulcers (signs of agranulocytosis)",
      "Skin rash (potential sign of serious reaction like SJS/TEN)",
      "Easy bruising or bleeding (sign of aplastic anemia)",
      "Jaundice (yellow skin/eyes), dark urine (sign of hepatotoxicity)",
    ],
    importantInvestigations: [
      "CBC (for blood cell counts)",
  ...
  },
  {
    ...
    importantInvestigations: [
      "Used for rapid tranquilization in acute agitation. Short-acting depot formulation.",
    ],
  },
];
...
const dosingData = {
  ...
  Alprazolam: {
    dosing:
      "Anxiety: 0.25–0.5 mg three times per day. Panic: Up to 1–10 mg per day in divided doses.",
    notes: "Titrate slowly. Avoid abrupt discontinuation. Risk of dependence.",
  },
  Amantadine: {
    dosing:
      "Parkinson's: 100 mg two times per day. Viral: 200 mg once daily or 100 mg two times per day.",
    notes: "Dose adjustment required in renal impairment.",
  },
  Amisulpride: {
    dosing:
      "Schizophrenia: 400–800 mg per day in 1-2 doses. Dysthymia: 50 mg per day.",
    notes:
      "Lower doses for negative symptoms, higher for positive psychotic symptoms.",
  },
  Amitriptyline: {
    dosing:
      "Depression: 25–150 mg per day as a single dose at bedtime. Neuropathic pain: 10–100 mg per day.",
    notes: "Start low to minimize side effects like dry mouth and sedation.",
  },
  Aripiprazole: {
    dosing:
      "Oral: 10–15 mg once daily. IM depot (Maintena): 300–400 mg monthly.",
  ...
  Asenapine: {
    ...
    notes:
      "Administer under the tongue only. Do not eat or drink for 10 minutes after dose.",
  },
  Atomoxetine: {
    dosing:
      "40–100 mg per day as a single daily dose or divided two times per day.",
  ...
  Biperidene: {
    dosing:
      "2 mg by mouth three times per day or four times per day. Maximum 16 mg per day.",
    notes: "For Parkinsonism and drug-induced movement side effects.",
  },
  Brexpiprazole: {
    dosing: "1–4 mg once daily.",
    notes:
      "Major Depressive Disorder (adjunct), Schizophrenia. Start at 0.5-1 mg.",
  },
  Bupropion: {
    dosing:
      "Sustained-Release: 150 mg two times per day. Extended-Release: 150–300 mg once daily.",
    notes:
  ...
  Chlordiazepoxide: {
    dosing:
      "Mild anxiety: 5–10 mg three or four times per day. Severe anxiety: 20–25 mg three or four times per day.",
  ...
  Clomipramine: {
    dosing:
      "25 mg daily, gradually increased to 100–250 mg per day in divided doses.",
  ...
  Clozapine: {
    ...
    notes:
      "Treatment-Resistant Schizophrenia. Requires strict blood monitoring. Titrate slowly.",
  },
  Desvenlafaxine: {
  ...
  Divalproex: {
    dosing:
      "Start 250–500 mg two times per day. Titrate to 1000–3000 mg per day.",
    notes: "Mood stabilization, seizures. Dose adjusted by serum levels.",
  },
  Donepezil: {
    dosing: "5–10 mg once daily at bedtime.",
    notes:
      "Alzheimer's Disease. Start at 5 mg for 4-6 weeks, then increase to 10 mg.",
  },
  Duloxetine: {
  ...
  Flupentixol: {
    dosing:
      "Oral: 3–9 mg two times per day. Depot IM: 20–40 mg every 2-4 weeks.",
    notes: "Schizophrenia.",
  },
  Fluvoxamine: {
    dosing:
      "50–300 mg per day. Start 50 mg at bedtime, increase by 50 mg every 4-7 days.",
    notes: "OCD, Social Anxiety Disorder, Depression.",
  },
  Gabapentin: {
    dosing:
      "300–3600 mg per day in 3 divided doses. Start 300 mg three times per day.",
    notes: "Neuropathic Pain, Seizures. Dose requires renal adjustment.",
  },
  Haloperidol: {
    dosing:
      "Oral: 1–15 mg per day in 2-3 divided doses. IM (acute): 2–5 mg. Depot: 50-200 mg monthly.",
  ...
  Memantine: {
    dosing:
      "Start 5 mg daily, titrate to 10 mg two times per day. Titrate weekly.",
  ...
  Naltrexone: {
    dosing:
      "Alcohol Use Disorder: 50 mg once daily. Opioid Use Disorder: 50 mg daily or 100 mg on Monday/Wednesday/Friday.",
  ...
  Oxcarbazepine: {
    ...
    notes:
      "Seizures. Start at 300 mg two times per day. Monitor sodium levels.",
  },
  Paliperidone: {
  ...
  Phenytoin: {
    dosing:
      "Loading dose: 15-20 mg/kg. Maintenance: 300-400 mg per day in 1-3 divided doses.",
    notes: "Seizures. Dosing is guided by serum levels.",
  },
  Pimozide: {
    dosing:
      "Initial: 1-2 mg per day. Maximum: 10 mg per day (rarely up to 20 mg for refractory Tourette's).",
    notes:
      "Tourette's syndrome, refractory psychosis. ECG monitoring required due to QTc prolongation risk.",
  },
  ...
  Pramipexole: {
    dosing:
      "Parkinson's: 1.5–4.5 mg per day in 3 divided doses. RLS: 0.125–0.75 mg once daily 2-3 hrs before bed.",
    notes: "Titrate slowly over several weeks.",
  },
  Quetiapine: {
    dosing:
      "Schizophrenia: 150–750 mg per day. Bipolar Depression: 300 mg daily. Depression (adjunct): 150-300 mg daily.",
  ...
  Topiramate: {
    dosing:
      "Migraine: 50–100 mg per day in 2 doses. Epilepsy: 200–400 mg per day in 2 doses.",
    notes: "Titrate slowly.",
  },
  Trazodone: {
    dosing:
      "Depression: 150–400 mg per day in divided doses. Insomnia: 25–100 mg at bedtime.",
  ...
  Vilazodone: {
    ...
    notes:
      "Major Depressive Disorder. Start at 10 mg for 7 days, then 20 mg for 7 days, then 40 mg.",
  },
  Vortioxetine: {
    dosing: "5–20 mg once daily.",
  ...
  Carbamazepine: {
    ...
    notes:
      "Seizures, Trigeminal Neuralgia, Bipolar Disorder. Dosing is guided by serum levels. Requires slow titration.",
  },
};
...
function showMedicationDetails(medName) {
  ...
  availabilityEl.textContent = medication.available
    ? "Available"
    : "Not Available";
  availabilityEl.className = medication.available
    ? "available-badge"
    : "not-available-badge";
